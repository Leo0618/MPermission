...
public class MainActivity extends AppCompatActivity implements MPermission.PermissionCallbacks {
    ...
    public void cameraTask() {
        if (MPermission.hasPermissions(this, Manifest.permission.CAMERA)) {
            // Have permission, do the thing!
            Toast.makeText(this, "TODO: Camera things", Toast.LENGTH_LONG).show();
        } else {
            // Ask for one permission
            MPermission.requestPermissions(this, getString(R.string.rationale_camera), RC_CAMERA_PERM, Manifest.permission.CAMERA);
        }
    }
    ...
    public void locationAndContactsTask() {
        ...
        if (MPermission.hasPermissions(this, perms)) {
            // Have permissions, do the thing!
            Toast.makeText(this, "TODO: Location and Contacts things", Toast.LENGTH_LONG).show();
        } else {
            // Ask for both permissions
            MPermission.requestPermissions(this, getString(R.string.rationale_location_contacts),
