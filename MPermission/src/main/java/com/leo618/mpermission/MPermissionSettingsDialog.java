...
public class MPermissionSettingsDialog implements Parcelable, DialogInterface.OnClickListener {
    ...
    public static final Creator<MPermissionSettingsDialog> CREATOR = new Creator<MPermissionSettingsDialog>() {
        @Override
        public MPermissionSettingsDialog createFromParcel(Parcel in) {
            return new MPermissionSettingsDialog(in);
        }

        @Override
        public MPermissionSettingsDialog[] newArray(int size) {
            return new MPermissionSettingsDialog[size];
        }
    };
    ...
    private MPermissionSettingsDialog(Parcel in) {
    ...
    private MPermissionSettingsDialog(@NonNull final Object activityOrFragment,
    ...
    /**
     * Builder for an {@link MPermissionSettingsDialog}.
     */
    public static class Builder {
        ...
        /**
         * Create a new Builder for an {@link MPermissionSettingsDialog}.
         *
         ...
         * MPermission#hasPermissions(Context, String...)} in {@link
        ...
        /**
         * Build the {@link MPermissionSettingsDialog} from the specified options. Generally followed by a
         * call to {@link MPermissionSettingsDialog#show()}.
         */
        public MPermissionSettingsDialog build() {
            ...
            return new MPermissionSettingsDialog(
                    mActivityOrFragment,
                    mContext,
                    mRationale,
                    mTitle,
